...
<body>
    <div class="container">
        ...
        <div class="form-section collapse" id="test3D">
            ...
            <form id="testForm3D">
                <div>
                    <label for="question1_3D">Question 1: Quel format de fichier doit être utilisé pour exporter un modèle 3D depuis un logiciel de modélisation ?</label>
                    <input type="text" id="question1_3D" name="question1_3D" required>
                </div>
                <div>
                    <label for="question2_3D">Question 2: Quel logiciel est utilisé pour configurer les paramètres d'impression et générer le fichier G-code ?</label>
                    <input type="text" id="question2_3D" name="question2_3D" required>
                </div>
                <div>
                    <label for="question3_3D">Question 3: Quelle partie de l'imprimante 3D peut atteindre des températures élevées ?</label>
                    <input type="text" id="question3_3D" name="question3_3D" required>
                </div>
                <div>
                    <label for="question4_3D">Question 4: Que doit-on vérifier pour les premières couches d'impression ?</label>
                    <input type="text" id="question4_3D" name="question4_3D" required>
                </div>
                <div>
                    <label for="question5_3D">Question 5: Que doit-on faire après avoir retiré un objet imprimé du lit d'impression ?</label>
                    <input type="text" id="question5_3D" name="question5_3D" required>
                </div>
        ...
        <div class="form-section collapse" id="testLaser">
            ...
            <form id="testFormLaser">
                <div>
                    <label for="question1_Laser">Question 1: Quel type de fichier est utilisé pour les dessins de découpe laser ?</label>
                    <input type="text" id="question1_Laser" name="question1_Laser" required>
                </div>
                <div>
                    <label for="question2_Laser">Question 2: Quelle est la précaution principale à prendre pour l'évacuation des fumées et des gaz ?</label>
                    <input type="text" id="question2_Laser" name="question2_Laser" required>
                </div>
                <div>
                    <label for="question3_Laser">Question 3: Que doit-on ajuster avant de démarrer la découpe ou la gravure ?</label>
                    <input type="text" id="question3_Laser" name="question3_Laser" required>
                </div>
                <div>
                    <label for="question4_Laser">Question 4: Pourquoi ne doit-on jamais laisser une découpeuse laser fonctionner sans surveillance ?</label>
                    <input type="text" id="question4_Laser" name="question4_Laser" required>
                </div>
                <div>
                    <label for="question5_Laser">Question 5: Quel matériau doit-on éviter de découper à cause des fumées toxiques ?</label>
                    <input type="text" id="question5_Laser" name="question5_Laser" required>
                </div>
    ...
    <script>
        function submitTest(testType) {
            ...
            if (testType === '3D') {
                ...
                question3 = document.getElementById('question3_3D').value.trim();
                question4 = document.getElementById('question4_3D').value.trim();
                question5 = document.getElementById('question5_3D').value.trim();
                ...
                question3 = document.getElementById('question3_Laser').value.trim();
                question4 = document.getElementById('question4_Laser').value.trim();
                question5 = document.getElementById('question5_Laser').value.trim();
            }
